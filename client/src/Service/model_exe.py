...
PATH="/content/drive/MyDrive/dev/졸작/models/res18/Brain_model.pt"
model=resnet_18()
optimizer = torch.optim.RMSprop(model.parameters(), lr=0.0001, weight_decay=0.001)
...
path="/content/drive/MyDrive/dev/졸작/brain"
...
def view_classify(img,ps):
    ...
    class_name = ['brain tumor(0)', 'healthy(1)']
