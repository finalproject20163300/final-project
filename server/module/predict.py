...
PATH="/home/dlxogns1004/react/model/Brain_model.pt"
# print('te', PATH)
model=resnet_18()
optimizer = torch.optim.RMSprop(model.parameters(), lr=0.000001, weight_decay=0.001)
...
class_name = ['brain tumor', 'healthy']
